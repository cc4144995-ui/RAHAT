...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    const fs = require("fs");
    return api.sendMessage("আসলাম আলাইকুম আমি আপনাদের গ্রুপ চলে আসছি সবাই কে আনন্দ  দেয়ার জন্য 😍কেমন আছেন সবাই", event.threadID, () => api.sendMessage({body:`➤⃚💕আসালামু আলাইকুম ⑅⃝✺❥᭄♥<<<<<------------------------------>>>>>  
TO VIEW ANY COMMAND
